...
namespace AI {
	...
	int getWinScore();
	double evaluateBoardForWhite(Model::Board board, bool blacksTurn);
	int getScore(Model::Board board, bool forBlack, bool blacksTurn);
	COORD calculateNextMove(int depth, Model::Board board);
	AI::EvaluatedMove minimaxSearchAB(int depth, Model::Board dummyBoard, boolean max, double alpha, double beta);
	AI::EvaluatedMove searchWinningMove(Model::Board board);
	int evaluateHorizontal(Model::Board board, bool forBlack, bool blacksTurn);
	int evaluateVertical(Model::Board board, bool forBlack, bool blacksTurn);
	int evaluateDiagonal(Model::Board board, bool forBlack, bool blackTurn);
	void evaluateDirections(Model::Board board, int i, int j, bool isBot, bool botsTurn, AI::Evaluation& evaluations);
